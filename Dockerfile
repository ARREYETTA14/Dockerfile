...
WORKDIR /opt/tomcat
ADD https://dlcdn.apache.org/tomcat/tomcat-11/v11.0.0-M15/bin/apache-tomcat-11.0.0-M15.tar.gz .
RUN tar -xvzf apache-tomcat-11.0.0-M15.tar.gz
RUN mv apache-tomcat-11.0.0-M15/* /opt/tomcat 
RUN apt-get update && \
